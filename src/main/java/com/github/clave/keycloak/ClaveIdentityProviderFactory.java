...
public class ClaveIdentityProviderFactory extends SAMLIdentityProviderFactory {
    ...
    public SAMLIdentityProviderConfig createConfig() {
        ...
        String defaultAttributes = String.join(",",
                ClaveAttributeMapper.PERSON_IDENTIFIER,
                ClaveAttributeMapper.GIVEN_NAME,
                ClaveAttributeMapper.FAMILY_NAME,
                ClaveAttributeMapper.DATE_OF_BIRTH);
        config.getConfig().put(CLAVE_REQUESTED_ATTRIBUTES, defaultAttributes);
