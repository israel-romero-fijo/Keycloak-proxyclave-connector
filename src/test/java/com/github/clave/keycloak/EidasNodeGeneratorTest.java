...
public class EidasNodeGeneratorTest {
    ...
    public void testEidasNodeGeneratorWithAttributes() throws Exception {
        ...
        assertTrue(xml.contains("eidas:RequestedAttribute Name=\"attr1\" isRequired=\"true\""));
        assertTrue(xml.contains("eidas:RequestedAttribute Name=\"attr2\" isRequired=\"true\""));
    }
}
